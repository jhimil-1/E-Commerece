...
class UIController {
    ...
    displayResults(results) {
        ...
        resultsContainer.innerHTML = results.map(item => {
            ...
            if (item.image_path && !item.image_path.includes('placeholder.com')) {
                imageSrc = item.image_path;
            } else if (item.image_url && !item.image_url.includes('placeholder.com')) {
            ...
            } else if (item.image && !item.image.includes('placeholder.com')) {
