...
class EnhancedProductHandler:
    ...
    def filter_irrelevant_results(self, query: str, products: List[Dict[str, Any]], 
        ...
        if min_semantic_score is None:
            # Special handling for phone/electronics queries
            ...
            elif any(word in query_lower for word in ['jewelry', 'jewellery', 'earrings', 'necklace', 'bracelet', 'ring']):
        ...
        for product in products:
            ...
            if any(word in query_lower for word in ['jewelry', 'jewellery', 'earrings', 'necklace', 'bracelet', 'ring']):
