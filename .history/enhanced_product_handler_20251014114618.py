...
class EnhancedProductHandler:
    ...
    def filter_irrelevant_results(self, query: str, products: List[Dict[str, Any]], 
        ...
        """
        print(f"DEBUG: filter_irrelevant_results called with query: '{query}', min_semantic_score: {min_semantic_score}")
        ...
        if min_semantic_score is None:
            ...
            if any(word in query_lower for word in headphones_words):
                ...
                min_semantic_score = 0.3  # Lower threshold - headphones products get 0.5, others get 0.0
        ...
        for product in products:
            ...
            if 'headphones' in query_lower or 'headphone' in query_lower or 'earbuds' in query_lower or 'earphone' in query_lower:
                ...
                print(f"DEBUG FILTER: Headphones query, checking semantic_score: {semantic_score} >= {min_semantic_score}, vector_score: {vector_score} >= {self.min_relevance_score * 0.5}")
                if semantic_score >= min_semantic_score and vector_score >= self.min_relevance_score * 0.5:
                    ...
                    print(f"DEBUG FILTER: HEADPHONES PASSED - {product.get('name', 'Unknown')}")
                else:
                    print(f"DEBUG FILTER: HEADPHONES FILTERED OUT - {product.get('name', 'Unknown')} (semantic: {semantic_score}, vector: {vector_score})")
    ...
    async def search_products_enhanced(self, query: str, user_id: str = None, 
        ...
        """
        print(f"DEBUG: search_products_enhanced called with query: '{query}'", flush=True)
