...
def list_gemini_models():
    """Lists all available Gemini models and writes them to a file."""
    try:
        with open("gemini_models.txt", "w") as f:
            for model in genai.list_models():
                f.write(f"Model Name: {model.name}, Supported Generation Methods: {model.supported_generation_methods}\n")
    except Exception as e:
