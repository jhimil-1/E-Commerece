    ...
    def search_similar_products(
        ...
        try:
            ...
            if filter_conditions or category_should_conditions:
                ...
                # For category filter, we need to use a should condition within the must
                if category_should_conditions:
                    # Create a should condition for category variations
                    category_condition = models.Filter(
                        should=category_should_conditions,
                        min_should_match=1
                    )
                    # Add this as a must condition (this is the correct way)
                    all_must_conditions.append(category_condition)
