                ...
                try:
                    ...
                    for hit in search_results:
                        ...
                        result = {
                            ...
                            "description": payload.get("description") or product.get("description", ""),
                            "price": float(payload.get("price") or product.get("price", 0.0)),
                            "category": payload.get("category") or product.get("category", "other"),
