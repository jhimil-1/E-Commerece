...
class EnhancedProductHandler:
    ...
    def filter_irrelevant_results(self, query: str, products: List[Dict[str, Any]], 
        ...
        for i, product in enumerate(products):
            print(f"DEBUG: Processing product {i+1}/{len(products)}: {product.get('name', 'Unknown')}")
            print(f"DEBUG: query_lower variable inside loop: '{query_lower}'")
            print(f"DEBUG: About to calculate semantic relevance...")
            ...
            print(f"DEBUG: {product.get('name', 'Unknown')} - semantic: {semantic_score}, vector: {vector_score}, combined: {combined_score}")
            ...
            print(f"DEBUG: Inside loop, checking headphones condition for query: '{query_lower}'")
            print(f"DEBUG: 'headphones' in query_lower: {'headphones' in query_lower}")
            print(f"DEBUG: 'headphone' in query_lower: {'headphone' in query_lower}")
            print(f"DEBUG: 'earbuds' in query_lower: {'earbuds' in query_lower}")
            print(f"DEBUG: 'earphone' in query_lower: {'earphone' in query_lower}")
            
            # Test the condition evaluation
            condition_result = 'headphones' in query_lower or 'headphone' in query_lower or 'earbuds' in query_lower or 'earphone' in query_lower
            print(f"DEBUG: Headphones condition result: {condition_result}")
            ...
            if condition_result:
                ...
                if semantic_score >= min_semantic_score and vector_score >= self.min_relevance_score * 0.5:
                    ...
                    # DO NOT ADD TO FILTERED_PRODUCTS
