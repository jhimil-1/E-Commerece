...
class ProductHandler:
    ...
    def _detect_category_from_query(self, query: str) -> str:
        ...
        category_keywords = {
            "clothing": {
                "primary": ["clothes", "clothing", "dress", "dresses", "apparel", "wear", "outfit"],
                "types": ["shirt", "pants", "jeans", "jacket", "coat", "skirt", "blouse", "sweater", "top", "bottom"],
                "attributes": ["casual", "formal", "summer", "winter", "men", "women", "unisex"]
            },
            "electronics": {
                "primary": ["electronics", "tech", "gadget", "device", "digital"],
                "types": ["phone", "smartphone", "laptop", "computer", "tablet", "tv", "camera", "headphones"],
                "brands": ["apple", "samsung", "sony", "lg", "dell", "hp"]
            },
            "jewelry": {
                "primary": ["jewelry", "jewellery", "accessories"],
                "types": ["necklace", "necklaces", "pendant", "chain", "ring", "rings", "earring", "earrings", "bracelet", "bracelets", "watch", "watches"],
