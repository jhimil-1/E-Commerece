        ...
        try:
            ...
            if category_filter:
                try:
                    ...
                    # Add OR condition for category variations as a separate should filter
                    if category_conditions:
                        category_filter_obj = models.Filter(
                            should=category_conditions,
                            min_should_match=1
                        )
                        # Store category filter separately to combine with must conditions later
                        category_filter_obj = category_filter_obj
